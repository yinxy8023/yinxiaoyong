...
function showPosition(position) {
	...
	var url = "http://api.map.baidu.com/geocoder/v2/?ak=96gLh1qxq0HUUt7vQ1FZj48U" + "&callback=renderReverse" + "&location=" + x + "," + y + "&output=json" + "&pois=0";
	$.ajax({
		type: "GET",
		dataType: "jsonp",
		url: url,
...
function setAddress(json) {
	var position = document.getElementById("city-this");
	//省
